...
export function ModernFloorCard({ andar }: FloorSectionProps) {
  // Cor customizável do andar com fallback para original
  const accentColor = (typeof window !== 'undefined' && localStorage.getItem('display-color-accent')) || '#3b82f6';
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 flex items-center justify-center h-full px-6">
            {/* Divisor tecnológico fino vertical esquerdo */}
            <div className="flex flex-col items-center mr-6">
              <div 
                className="relative w-[0.15px] h-12"
                style={{
            ...
            <div className="flex-1 text-center">
              <div className="flex items-center justify-center gap-2">
                ...
                {/* Divisor high-tech fino */}
                <div 
                  className="relative w-[1px] h-12 mx-1"
                  style={{
                  background: `linear-gradient(180deg, transparent, ${accentColor}70, ${accentColor}80, ${accentColor}70, transparent)`,
                  boxShadow: `0 0 8px ${accentColor}50, 0 0 15px ${accentColor}25`,
